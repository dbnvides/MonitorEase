...
export const ModalRegister = () => {
  const { closeModal, modalRegister } = useContext(ModalContext)
      ...
      <form onSubmit={addnewServiceForm.handleSubmit(onSubmit)} className="space-y-6 mt-10 text-white">
        ...
        <div className='flex gap-4 flex-col'>
            ...
            render={({ field }) => (
                ...
                <FormControl>
                    <Input placeholder="Digite seu email" {...field} className='rounded border-2 placeholder:text-slate-400'/>
                </FormControl>
                <FormMessage />
                </FormItem>
            )}
        ...
        <div className='w-full flex gap-2 justify-end'>
            <Button type="submit" className='text-white bg-zinc-950 rounded-[4px]'>Salvar</Button>
